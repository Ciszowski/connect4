    ...
    // game variables
    var gameOver, gameTied, grid = [], playersTurn, timeComp,ctx;
    ...
    export function highlightGrid(/** @type {MouseEvent} */ ev) {
        if (!playersTurn || gameOver) {
            return;
        }
    ...
    export function setDimensions(canv) {
        console.log("dimensions change", canv)
